    ...
    <header class="@if (get_setting('header_stikcy') == 'on') sticky-top @endif z-1020 header_position">
                        ...
                        @else
                            ...
                            <span class="d-flex align-items-center nav-user-info ml-2">
                                ...
                                <!-- <a href="{{ route('user.login') }}"
                                    class="text-reset opacity-60 hov-opacity-100 hov-text-primary fs-12 d-inline-block  border-soft-light border-width-2 pr-2 ml-3">{{ translate('Login') }}</a>
        ...
        <div class="d-none d-lg-block position-relative mt-md-3">
            ...
            <!-- <div class="hover-category-menu position-absolute w-100 top-100 left-0 right-0 z-3 d-none"
                ...
                <div class="container">
                            ...
                            <form action="{{ route('search') }}" method="GET" class="stop-propagation">
                                <div class="d-flex position-relative align-items-center">
                                    ...
                                    <div class="search-input-box">
                                        <input type="text"
                                            class="border border-soft-light form-control fs-18 hov-animate-outline"
                                        ...
                                        <svg id="Group_723" data-name="Group 723" xmlns="http://www.w3.org/2000/svg"
                                            width="20.001" height="30" viewBox="0 0 20.001 20">
                    ...
                    @if (Auth::check() && auth()->user()->user_type == 'customer')
                        <!-- Compare -->
                        <div class="d-none ml-3 mr-0">
                            <div class="" id="compare">
                                @include('frontend.partials.compare')
                            </div>
                        </div>
                        <!-- Wishlist -->
                        <div class="d-none mr-3" style="margin-left: 36px;">
            ...
            <!-- Loged in user Menus -->
            <div class="hover-user-top-menu position-absolute top-65 left-0 right-0 z-3">
                <div class="container">
