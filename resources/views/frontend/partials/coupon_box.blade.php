    ...
    <div class="position-absolute" style="bottom:1rem; left:2rem; right:2rem">
        <div class="px-4 mt-2">
            @if($coupon->type == 'product_base')
                ...
                <div class="aiz-carousel slick-left gutters-16" data-items="6" data-lg-items="6"  data-md-items="3" data-sm-items="4" data-xs-items="4" data-arrows='false' data-infinite='true' data-autoplay="true">
