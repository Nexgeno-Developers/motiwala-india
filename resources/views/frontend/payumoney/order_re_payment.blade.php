@php
    ...
    */
    ...
    $pum = [
        ...
        'amount' => number_format(\App\Models\Order::findOrFail(Session::get('payment_data')['order_id'])->grand_total, 2, '.', ''),
        ...
        'udf1' => auth()->user()->id,
        'udf2' => 'order_re_payment',
        'udf3' => 'none',
        'udf4' => Session::get('payment_data')['order_id'],
