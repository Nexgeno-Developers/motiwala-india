<div class="sticky-top z-3 row gutters-10">
    ...
    <!-- Thumbnail Images -->
    <div class="col-2 d-lg-block order-md-1 order-2">
    ...
    <div class="col-10 order-md-2 order-1">
        <div class="aiz-carousel product-gallery arrow-inactive-transparent arrow-lg-none gray_bg" 
            data-nav-for='.product-gallery-thumb' data-fade='true' data-auto-height='true' data-arrows='true'>
            @if ($detailedProduct->digital == 0)
                @foreach ($detailedProduct->stocks as $key => $stock)
                    @if ($stock->image != null)
                        <div class="carousel-box img-zoom rounded-0">
                            <img class="img-fluid h-auto lazyload mx-auto w-100"
                                src="{{ static_asset('assets/img/placeholder.jpg') }}"
                                data-src="{{ uploaded_asset($stock->image) }}"
                                onerror="this.onerror=null;this.src='{{ static_asset('assets/img/placeholder.jpg') }}';">
                        </div>
